...
@section('content')
	...
	<form class="profile_form">
	  ...
	  <div class="form-group">
	  	...
	  	<div class="relative">
            <img style="height: 200px; width: 200px; border-radius: 100px; margin-left: 100px;" name="image" id='previmage' src="{{asset('Backend_assets/images/img_avatar2.png')}}" alt="image" class='img-responsive'>
            <br><br>
