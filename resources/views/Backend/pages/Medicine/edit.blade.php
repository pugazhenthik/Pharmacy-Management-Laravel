...
@section('content')
    ...
    <div class="col-md-12 center">
        <div class=" card-header">
            <h3>Edit Medicine</h3><a href="{{ url('/admin/medicine') }}"><button class="btn btn-dark float-right">List</button></a> 
        </div>
        </div>
        <div class="card mt-3">
        <form action="{{ route('medicine.update',($medicine->med_id)) }}" method="post" id="addForm" enctype="multipart/form-data">
            @csrf
        <div class="row mt-4">
            <div class="col-md-6">
            ...
            <div class="form-group col-md-12">
                ...
                <div class="form-group col-md-12">
                    <div class="col-sm-7">
                        ...
                        <input type="file" id="image" class="form-control" name="med_image">
                    </div>
                </div>
         </div> 
         <div class="col-md-6">
