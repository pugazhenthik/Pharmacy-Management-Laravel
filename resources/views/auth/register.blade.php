            ...
            <div class="form-form-wrap">
                <div class="form-container">
                    <div class="form-content">
                        ...
                        <p class="signup-link">You have an account <a href="{{ route('login') }}">Go</a></p>
                        @if (session('status'))
                        ...
                        @endif
                            ...
                            <div class="form">
                                ...
                                <div id="username-field" class="field-wrapper input">
                                    ...
                                    <input class="form-control" type="text" name="name" :value="old('name')" required autofocus autocomplete="name" placeholder="UserName">
                                </div>
                                ...
                                <div id="password-field" class="field-wrapper input mb-2">
                                    ...
                                    <input class="form-control" type="password" name="password_confirmation" required autocomplete="new-password" placeholder="Match Password">
                                </div>
